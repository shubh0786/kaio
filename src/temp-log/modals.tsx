  ...
  return (
    <ModalShell onClose={onClose}>
      ...
      <div className="flex justify-between gap-2 mt-4">
        <button onClick={() => { deleteUnit(unitId); onClose(); }} className="min-h-[44px] px-4 text-sm font-semibold text-red-600 hover-danger rounded-xl"><Trash2 size={14} className="inline mr-1" />Delete</button>
        <div className="flex gap-2">
